...
Kata encontrada en Exeal: Exeal.HexaShort

HexaShort es una kata práctica para aprender arquitectura hexagonal creando un acortador de URLs. Usa TDD, puertos y adaptadores paso a paso.
Problema de negocio
